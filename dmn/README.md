...
| Metric | Value |
|---|---|
| DMN files | 40 (one per process area that yields ≥ 1 decision) |
| Decisions | 79 |
| Decision-table rules | 339 |
...
*Generated by `07-methodology/generate-dmn.py` · source corpus: 79 decisions
