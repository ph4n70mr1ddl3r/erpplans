...
│   ├── workflows/                      3,228 workflows organized by value stream
│   │   ├── value-stream-index.md              Master index (8 families · 100 value streams · 304 process areas)
...
| Workflows (total) | **3,228** across 100 value streams, 304 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
    │  erp-requirements.md ←→ workflows/ (3,228 WF)    │
   │       ↕                    ↕                      │
