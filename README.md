...
│   ├── workflows/                      5,426 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,449 rows)
...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── ai-first-operating-guide.md   The AI-first operating guide — ERP-agnostic doctrine (ten laws, six layers, capability contracts), sourcing neutrality, autonomy ladder, agent factory, the EKB as persistent memory + consistency engine, the no-confusion decision system, and the seven-phase adoption path (v1.9)
    ├── validate-repo.sh              Cross-reference validation (72 checks)
...
| Workflows (total) | **5,426** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,426 WF)    │
   │       ↕                    ↕                      │
