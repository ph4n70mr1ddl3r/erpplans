...
│   ├── workflows/                      5,422 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,445 rows)
...
│   │   ├── VS-07-store-operations/              150 workflows (4 process areas)
...
│   │   ├── VS-14-marketing/                     41 workflows (3 process areas)
...
│   │   ├── VS-24-health-safety-environment/     30 workflows (3 process areas)
│   │   ├── VS-25-esg-sustainability/            31 workflows (3 process areas)
│   │   ├── VS-26-business-continuity-insurance/ 30 workflows (3 process areas)
│   │   ├── VS-27-it-operations-security/        70 workflows (3 process areas)
...
| Workflows (total) | **5,422** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,422 WF)    │
   │       ↕                    ↕                      │
