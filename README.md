...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── semantic-audit-coverage.txt  Audited-W-id registry — LOOP CLOSED 2026-09-02 at 5,363 of 5,363; W5511 audited in full + detector-swept and admitted 2026-09-03 → 5,364 of 5,364 (2,241 stratified full-reads reviews #44–#67 + the review-#71 final-coverage detector pass; the fork-local batches 22–29 read their 832 post-fork W-ids in full — see the merge note atop CHANGELOG)
