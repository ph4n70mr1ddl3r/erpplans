...
│   ├── workflows/                      5,387 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,410 rows)
...
│   │   ├── VS-19-hire-to-retire/                79 workflows (5 process areas)
...
| Workflows (total) | **5,387** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
