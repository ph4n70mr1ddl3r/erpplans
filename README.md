...
│   ├── workflows/                      5,418 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,441 rows)
...
│   │   ├── VS-08-pos-checkout/                  60 workflows (3 process areas)
...
| Workflows (total) | **5,418** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,418 WF)    │
   │       ↕                    ↕                      │
