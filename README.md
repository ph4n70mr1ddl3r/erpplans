...
│   ├── workflows/                      4,788 workflows organized by value stream
│   │   ├── README.md                           Navigation hub & quick stats
│   │   ├── value-stream-index.md              Master index (8 families · 165 value streams · 499 process areas)
...
| Workflows (total) | **4,788** across 165 value streams, 499 process areas | `01-model-company/workflows/value-stream-index.md` |
...
| Workflows | 4,788 fully specified across 165 value streams | `workflows/value-stream-index.md` |
| Criticality classification | **1,145 of 4,788 workflows classified** (24%; the confirmed register holds 1,168 rows incl. 23 `###` parent/summary sub-workflows); 3,643 remain unclassified, all carrying a keyword-driven proposed tier in `workflow-criticality-proposed.md` pending review | `workflows/workflow-criticality-classification.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (4,788 WF)    │
   │       ↕                    ↕                      │
