...
| Criticality classification | **1,529 of 4,981 workflows classified** (31%; the confirmed register holds 1,552 rows incl. 23 `###` parent/summary sub-workflows); 3,452 remain unclassified, all carrying a keyword-driven proposed tier in `workflow-criticality-proposed.md` pending review | `workflows/workflow-criticality-classification.md` |
