...
│   ├── workflows/                      4,740 workflows organized by value stream
│   │   ├── README.md                           Navigation hub & quick stats
│   │   ├── value-stream-index.md              Master index (8 families · 163 value streams · 493 process areas)
...
| Workflows (total) | **4,740** across 163 value streams, 493 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (4,740 WF)    │
   │       ↕                    ↕                      │
