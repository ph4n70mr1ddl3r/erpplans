...
| Criticality classification | **1,721 of 4,981 workflows classified** (35%; the confirmed register holds 1,744 rows incl. 23 `###` parent/summary sub-workflows); 3,260 remain unclassified, all carrying a keyword-driven proposed tier in `workflow-criticality-proposed.md` pending review | `workflows/workflow-criticality-classification.md` |
