...
│   ├── workflows/                      4,860 workflows organized by value stream
│   │   ├── README.md                           Navigation hub & quick stats
│   │   ├── value-stream-index.md              Master index (8 families · 168 value streams · 508 process areas)
...
| Workflows (total) | **4,860** across 168 value streams, 508 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (4,860 WF)    │
   │       ↕                    ↕                      │
