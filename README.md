...
| Criticality classification | **2,297 of 4,981 workflows classified** (46%; the confirmed register holds 2,320 rows incl. 23 `###` parent/summary sub-workflows); 2,684 remain unclassified, all carrying a keyword-driven proposed tier in `workflow-criticality-proposed.md` pending review | `workflows/workflow-criticality-classification.md` |
