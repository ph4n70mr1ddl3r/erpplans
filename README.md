...
│   ├── workflows/                      5,414 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,437 rows)
...
│   │   ├── VS-147-customer-safety-premises-liability-and-in-store-risk-management/ 25 workflows (3 process areas)
...
| Workflows (total) | **5,414** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,414 WF)    │
   │       ↕                    ↕                      │
