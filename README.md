...
│   ├── workflows/                      5,402 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,425 rows)
...
│   │   ├── VS-24-health-safety-environment/     29 workflows (3 process areas)
...
| Workflows (total) | **5,402** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,402 WF)    │
   │       ↕                    ↕                      │
