...
│   ├── workflows/                      5,396 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,419 rows)
...
│   │   ├── VS-19-hire-to-retire/                80 workflows (5 process areas)
...
│   │   ├── VS-24-health-safety-environment/     28 workflows (3 process areas)
...
│   │   ├── VS-79-tax-management-bir-reporting/     26 workflows (3 process areas)
...
| Workflows (total) | **5,396** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,396 WF)    │
   │       ↕                    ↕                      │
