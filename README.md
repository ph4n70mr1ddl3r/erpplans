...
│   ├── workflows/                      1,490 workflows organized by value stream
...
│   │   ├── VS-01-merchandise-strategy/         44 workflows (3 process areas)
│   │   ├── VS-02-supply-planning/               36 workflows (3 process areas)
│   │   ├── VS-03-vendor-management/             80 workflows (4 process areas)
│   │   ├── VS-04-dc-warehouse/                  44 workflows (3 process areas)
│   │   ├── VS-05-inventory-lifecycle/           34 workflows (3 process areas)
│   │   ├── VS-06-logistics-fleet/               33 workflows (3 process areas)
│   │   ├── VS-07-store-operations/              140 workflows (4 process areas)
│   │   ├── VS-08-pos-checkout/                  57 workflows (3 process areas)
│   │   ├── VS-09-in-store-services/             156 workflows (3 process areas)
│   │   ├── VS-10-ecommerce-digital/             58 workflows (3 process areas)
│   │   ├── VS-11-trade-project-wholesale/       48 workflows (3 process areas)
│   │   ├── VS-12-installation-services/         32 workflows (3 process areas)
│   │   ├── VS-13-customer-experience/           62 workflows (3 process areas)
│   │   ├── VS-14-marketing/                     32 workflows (3 process areas)
│   │   ├── VS-15-procure-to-pay/                42 workflows (2 process areas)
│   │   ├── VS-16-order-to-cash/                 33 workflows (3 process areas)
...
│   │   ├── VS-21-internal-audit-risk/           47 workflows (3 process areas)
│   │   ├── VS-22-compliance-regulatory/         57 workflows (3 process areas)
│   │   ├── VS-23-loss-prevention/               26 workflows (3 process areas)
│   │   ├── VS-24-health-safety-environment/     26 workflows (3 process areas)
│   │   ├── VS-25-esg-sustainability/            28 workflows (3 process areas)
│   │   ├── VS-26-business-continuity-insurance/ 27 workflows (3 process areas)
