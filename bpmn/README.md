...
| BPMN processes | 5,449 (one per workflow block, incl. the 23 `###`/`####` sub-workflows such as W5A) |
| Tasks | 23,008 |
| Sequence flows | 28,457 (= tasks + one task→end flow per process) |
| Diagrams (DI) | 5,449 — every process carries full BPMNDiagram/BPMNPlane/shape/edge interchange |
...
*Generated by `07-methodology/generate-bpmn.py` · source corpus: 5,449 workflow blocks across 188 value streams / 569 process areas*
