...
### Controls
- CTL-255 (ensure controlled execution — Inventory Disposition and Optimization (PA-05.3).)
...
### Automation Opportunity
- System auto-capture of "manually creates adjustment request with reason code and supporting…" (replaces manual Step 1).
- System auto-scan of "scanning error" (replaces manual Step 2).
- System auto-log of "logs, check transfer records, review CCTV if theft suspected" (replaces manual Step 3).
...
### Automation Opportunity
- System auto-flag of "flags stock as "Damaged" or "Suspect"" (replaces manual Step 1).
- System auto-generate of "prints "Quarantine Label" from system" (replaces manual Step 2).
...
- System auto-generate of "generates a "Repack/Conversion Order" linking Bulk SKU" (replaces manual Step 2).
...
- System auto-document of "documented results," (replaces manual Step 2).
...
### Time Estimate
- Step 1: Automated
- Step 2: 3–4 hours/month
- Step 3: 2 hours/month
- Step 4: 3 hours/month
- Step 5: 5–15 min/approval; Board resolution: 1 board meeting/quarter
- Step 6: 4–6 hours/quarter for documentation package
- Step 7: 2–3 hours/batch (quarterly)
- Step 8: 2–4 hours/location per quarterly batch
- Step 9: 3 hours/quarter
- Step 10: 8–10 hours/year
- *Draft roll-up from per-step Durations (mechanically derived by `07-methodology/backfill-time-estimate.py`). Annualize per the workflow's Frequency/Volume where the total drives headcount; refine to the per-step range + annual figure house style shown in WORKFLOW-FORMAT-GUIDE.md.*
...
### Time Estimate
- Step 1: 1 day/season
- Step 2: 3–4 hours/season
- Step 3: 4 hours/season
- Step 4: 4–6 hours/season
- Step 5: 3–4 hours/season
- Step 6: 4–8 hours/store per transition
- Step 7: Per W4 receiving; 2–3 hours/store for staging
- Step 8: 6–10 hours/store per transition
- Step 9: 1 day/season
- Step 10: 4–6 hours/season
- *Draft roll-up from per-step Durations (mechanically derived by `07-methodology/backfill-time-estimate.py`). Annualize per the workflow's Frequency/Volume where the total drives headcount; refine to the per-step range + annual figure house style shown in WORKFLOW-FORMAT-GUIDE.md.*
...
- System auto-generate of "generates "Bagged Material Shelf Life Report" showing" (replaces manual Step 2).
...
### Automation Opportunity
- System auto-review of "review" (replaces manual Step 1).
- System auto-generate of "generate store allocation plan based on" (replaces manual Step 2).
...
- System auto-capture of "enters return reason code" (replaces manual Step 2).
...
- System auto-count of "count retailers, liquidators, or LGU donation" (replaces manual Step 3).
