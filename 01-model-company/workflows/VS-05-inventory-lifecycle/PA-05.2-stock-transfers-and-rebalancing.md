...
- auto-request (requestor identifies transfer need)
- auto-create (requestor creates transfer order in)
- auto-validate (system checks availability at source)
...
### Automation Opportunity
- auto-forecast (× baseline forecast), and maximum shelf)
- auto-calculate (supply planner calculates promotional stock requirement)
- auto-validate (supply planner checks dc inventory for)
...
### Automation Opportunity
- auto-log ((e) override log — all instances)
- auto-review (planning manager reviews allocation performance with)
- rule-based auto-approval (the right approvers involved? should any)
...
### Automation Opportunity
- auto-identify (**analysis**: identify skus with "overstock")
- auto-generate (order**: system generates "push" stock transfers)
- auto-log (**logistics**: consolidate transfers into)
...
### Automation Opportunity
- auto-validate (high-demand sku; checks "regional inventory" in)
- auto-request (**transfer request**: store a manager)
- rule-based auto-approval (supply planner approves based on regional)
...
### Automation Opportunity
- auto-validate (sales associate checks real-time inventory in)
- auto-generate (a; system generates a "customer-initiated transfer)
- auto-route (system automatically routes a high-priority pick)
...
### Automation Opportunity
- auto-review (supply planner reviews "dc-to-dc inventory health")
- auto-log (**fulfillment booking**: logistics books heavy-duty transport)
- auto-track (dcs; system tracks "in-transit" at wac)
...
### Automation Opportunity
- auto-review (planning manager reviews recommendations: (i) validate)
- auto-post (confirmation: system posts goods issue —)
- auto-log (coordinate with logistics provider per w66)
...
### Automation Opportunity
- auto-record (catch-weight sales recording** (at pos per)
- auto-calculate ((a) system recalculates wac per catch-weight)
- auto-count (catch-weight cycle count** (per w6 cycle)
...
### Automation Opportunity
- auto-review (planning manager reviews: (a) is there)
- auto-route ((c) inter-island route availability)
- auto-create (planning manager creates emergency transfer order;)
