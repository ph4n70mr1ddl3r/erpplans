...
- **Manual shrinkage checking effort** — daily physical checking of top 20 consignment SKUs across 200 stores = ~2,000 store-hours/month; stores may deprioritize this during busy periods, increasing risk of undetected shrinkage; mitigated by CTL-253 (controlled execution — Inventory Accuracy & Counting (PA-05.1))
