...
- System auto-flag of "flags variances" (replaces manual Step 4).
...
- System auto-count of "count or trade account" (replaces manual Step 3).
- System auto-import of "import item — shows import PO ETA" (replaces manual Step 4).

### Controls
- CTL-253 (ensure controlled execution — Inventory Accuracy and Counting (PA-05.1).)
...
- System auto-scan of "scanned" (replaces manual Step 2).
- System auto-match of "match at GR" (replaces manual Step 4).
...
### Automation Opportunity
- System auto-generate of "generates "Sold Consignment Report" with quantity sold, POS transaction…" (replaces manual Step 1).
- System auto-count of "count reconciliation" (replaces manual Step 2).
...
### Time Estimate
- Step 1: Automated
- Step 2: 2 hours/store/month (200 stores × 2 hours = 400 hours/month; distributed across store staff)
- Step 3: 2 hours/week
- Step 4: 1 hour/vendor
- Step 5: Vendor-side
- Step 6: 30 min/vendor
- Step 7: 2 hours/month
- Step 8: 2 hours/vendor/quarter
...
### Automation Opportunity
- System auto-count of "count completes" (replaces manual Step 1).
