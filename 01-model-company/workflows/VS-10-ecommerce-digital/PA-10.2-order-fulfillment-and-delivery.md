...
| **Volume** | ~42,900 ecommerce orders/month (~1,430/day); mix of BOPIS (~25,700/month), home delivery from DC (~12,900/month), ship-from-store (~2,800/month, per W19B/W1196 reconciled), and drop-ship vendor (~1,500/month); SLA metrics tracked per order per fulfillment origin |
...
| **Frequency** | ~8,600–10,700 ecommerce returns/month (ecommerce return rate of ~20–25% of orders; ~42,900 orders/month × 20–25% ≈ 43–54 returns/store/month) |
