...
### Pain Points / Risks
- **DOLE Department Order 198-18** — full compliance with the OSH Standards requires documented risk assessments, safety committees, and qualified safety officers per establishment; mitigated by CTL-226 (OHS compliance & incident management)
...
- System auto-create of "Incident Report" (replaces manual Step 2).
...
### Automation Opportunity
- System workflow notification of "contacts" (replaces manual Step 3).
...
### Time Estimate
4.25 hours per occurrence (per-step effort 4 hours + 15 min); plus unit-priced steps at their own unit (1 hour/loc); elapsed timeline 3 days + 2 days + 1 day — at Annual ≈ 1 occurrence/year ≈ 4.25 hours/year.
...
| **Volume** | 6,762 employees requiring various safety certifications across 200 stores, 4 DCs, and HQ |
...
### Automation Opportunity
- System auto-renew of "renewal" (replaces manual Step 1).
...
| **Volume** | ~6,762 employees across 200 stores, 4 DCs, and HQ; high-risk roles: cashiers (prolonged standing, repetitive scanning), DC pickers (lifting, bending), lumber yard staff (heavy lifting), paint mixing staff (repetitive arm motion) |
| **Owner** | Safety Officer |
...
| **Volume** | ~6,762 employees; ~1,500–2,000 annual medical examinations for DC staff, drivers, paint/chemical handlers, and noise-exposed roles |
...
- System auto-validate of "check, sleep apnea screening, driving fitness assessment per LTFRB requirements" (replaces manual Step 2).
...
| **Volume** | ~205 sites (200 stores + 4 DCs) with ~6–10 outdoor-exposed roles per store (lumber yard per W438, garden center, receiving dock, parking and cart crews) and ~25–35 per DC (docks, yard, van loading) → ~1,700–2,300 employees directly exposed on a chain-wide Danger day, plus delivery and installation crews in non-air-conditioned vehicles (VS-06/VS-12) |
| **Owner** | Safety Officer |
...
### Pain Points / Risks
- **Fatality and regulatory exposure**: heatstroke is life-threatening and a reportable OSH incident under RA 11058/DO 198-18; mitigated by the threshold matrix, acclimatization and the emergency-response steps (1, 2, 5)
