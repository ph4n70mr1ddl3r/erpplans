...
- auto-log (receives and logs loa in system:)
- continuous audit (cfo assess audit scope and risk;)
- auto-record ((h) inventory records and physical count)
...
### Automation Opportunity
- auto-review (and controller review and sign annual)
- auto-document (general controls documentation (access controls, change)
- auto-count ((g) inventory count documentation from w42)
...
| 7 | **Archival & Retention**: Verify 10-year data retention and accessibility of archived accounting data (W15.3) | IT Manager | — | 1 hour |
...
### Automation Opportunity
- auto-document (**system documentation update**: maintain up-to-date)
- auto-validate (trail verification**: verify that all transactions)
- auto-count ("books of accounts" in bir-required formats)
...
### Automation Opportunity
- auto-submit (customer submits a formal dsr)
- auto-count (verified email/loyalty account.)
- auto-log (or anonymization; logs request in dsar)
...
### Automation Opportunity
- auto-monitor (regulatory officer monitors (a) ndrrmc and)
- auto-generate (per w310; generates affected location list)
- auto-flag (event); system flags these skus with)

### Controls
operational: tracking; operational: activation, physical shelf label replacement at 50+ affected stores takes 2–4 hours
...
### Automation Opportunity
- auto-document (complaint, supporting documents provided by complainant)
- auto-log (**case logging and triage**: regulatory)
- auto-record (pricing setup records (w262) if complaint)
...
| **Volume** | ~6,757 employees across 5 entities; annual testing targets ~20–30% random sample (~1,300–2,000 tests/year) |
...
### Automation Opportunity
- auto-review (compliance manager reviews and updates buildright's)
- auto-report ((b) candidate reports to dole-accredited laboratory)
- auto-generate (compliance manager prepares the annual random)
...
### Automation Opportunity
- auto-log ((b) doh epidemiological bulletins and alert)
- auto-assign (distribution); (d) assign prt roles: operations)
- auto-capture (lgu health centers)
...
### Automation Opportunity
- auto-inspect (receives dole inspection notice; classifies inspection)
- auto-document (ohs-related); assigns document preparation responsibilities)
- auto-record (incentive leave records; (e) overtime computation)
...
### Automation Opportunity
- auto-inspect (manager receives inspector; verifies inspector credentials)
- auto-validate (with inspection-specific checklist and guidance)
- auto-record ((permits, licenses, records); does not volunteer)
...
### Automation Opportunity
- auto-document (w678; (c) document findings with photographic)
- auto-review (product safety review with merchandising and)
- auto-generate (counter; (ii) printed on receipts; (iii))
...
### Automation Opportunity
- auto-document (vendor tax documents: (i) bir tin)
- auto-record (duplicate vendor records or fraud); (iii))
- auto-review (tax compliance review**: q1 each year,)

### Controls
operational: is not always accessible or up-to-date, making validation difficult
...
| Field | Detail |
|---|---|
| **Trigger** | Cash transaction at POS exceeds PHP 500,000 single transaction threshold, or aggregate cash transactions from same customer exceed PHP 500,000 in a 5-business-day rolling period, or suspicious transaction indicators detected |
...
### Automation Opportunity
- auto-capture (account, or cashier-entered name/mobile) ≥ php)
- auto-route (flagged transactions routed to compliance officer)
- auto-record (pos transaction record, customer id copy,)

### Controls
operational: to record your ID for our records, sir/ma'am") without mentioning AMLC
...
| 2 | Tax Manager prepares renewal documentation: updated system description, list of modules, sample outputs (invoice, receipt, journal entry, financial statements), system security description, and backup/retention procedures | Tax Manager | IT Director | 4–6 hours/renewal |
| 3 | IT Director reviews and confirms system description accuracy; provides evidence of any changes since last registration (version upgrades, new integrations, infrastructure changes) | IT Director | — | 1–2 hours/renewal |
...
| 7 | For system changes between renewals: IT Director notifies Tax Manager of planned ERP changes; Tax Manager assesses whether change requires BIR notification (material changes) or can be documented internally (immaterial changes) | IT Director / Tax Manager | Controller | Per change event |
...
- Total: ~48–82 hours/year for Tax Manager, IT Director, and External Tax Advisor
...
### Automation Opportunity
- auto-track (registration calendar: tracks expiry dates for)
- auto-document (prepares renewal documentation: updated system description,)
- auto-review (it director reviews and confirms system)
...
- IT Director: ~4–8 hours/year reviewing system descriptions and confirming change notifications
...
| **Frequency** | Periodic (estimated 1–3 inspections/year across 205 locations); higher frequency for DCs with hazardous material storage and stores with DENR Permit to Operate (W477) |
...
| **Owner** | Compliance Officer |
| **Participants** | Compliance Officer, Store/DC Manager, Facilities Coordinator, Environmental Consultant, Legal Head, DENR Inspector |
...
- **Hazardous waste storage duration violations**: DENR DAO 2004-36 limits hazardous waste storage to 6 months; stores with low hazardous waste generation rates (used batteries, empty containers) may not reach a full load for economical disposal within 6 months, creating a compliance vs. cost tension
...
### Automation Opportunity
- auto-record ((cmr) submission records (per w433), (e))
- auto-inspect (**inspection day — announced**:)
- auto-document (areas and documents per legal obligation)

### Controls
operational: documentation

### Time Estimate
- Pre-inspection readiness review: ~4 hours/location/quarter for Compliance Officer; ~820 hours/year across 205 locations (risk-based, not all locations each quarter)
...
- Total: ~200–400 person-hours/year
