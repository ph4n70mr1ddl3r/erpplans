...
### Automation Opportunity
- System auto-document of "Documentation Update" (replaces manual Step 1).
- System auto-validate of "Verify that all transactions" (replaces manual Step 2).
- System auto-count of "counts" in BIR-required formats" (replaces manual Step 3).
...
### Automation Opportunity
- System auto-monitor of "monitors" (replaces manual Step 1).
- System auto-generate of "generates affected location list with address and operating status" (replaces manual Step 2).
- System auto-flag of "flags these SKUs with "Price Freeze – Affected" status" (replaces manual Step 3).
...
- Step 2: 30 min/event
- Step 3: 1 hour/event
- Step 4: Automated (30 min validation)
- Step 5: 1–2 hours/event
- Step 6: 30 min
- Step 7: 2–4 hours/store
- Step 8: Automated + 30 min/day review
- Step 9: 1–2 hours/event
- Step 10: 1–2 hours/event
- Step 11: 1 hour/event
- Step 12: Absorbed into annual reporting
...
- Step 1: 30 min/case
- Step 2: 15 min/case
- Step 3: 2–4 hours/case
- Step 4: 1–2 hours/case
- Step 5: 2–4 hours/case
- Step 6: 2–4 hours/mediation session
- Step 7: 1–2 hours/case
- Step 8: 2–6 months/case
- Step 9: 1–4 hours/case + implementation time
- Step 10: 2 hours/quarter
- *Draft roll-up from per-step Durations (mechanically derived by `07-methodology/backfill-time-estimate.py`). Annualize per the workflow's Frequency/Volume where the total drives headcount; refine to the per-step range + annual figure house style shown in WORKFLOW-FORMAT-GUIDE.md.*
...
### Automation Opportunity
- System auto-log of "logical Bulletins and Alert Level system" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-inspect of "inspection notice" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-capture of "entered name/mobile" (replaces manual Step 1).
