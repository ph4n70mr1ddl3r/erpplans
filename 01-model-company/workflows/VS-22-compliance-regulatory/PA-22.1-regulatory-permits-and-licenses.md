...
| # | Activity | Role (R) | Role (A) | Duration |
|---|---|---|---|---|
| 1 | Regulatory Officer obtains BIR CAS registration forms: BIR Form 1907 (Application for Authority to Print Receipts/Invoices, filed alongside the CAS application), together with system documentation package | Regulatory Officer | Legal Head | 4 hours/entity |
