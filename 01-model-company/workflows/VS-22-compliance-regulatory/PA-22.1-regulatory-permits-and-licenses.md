...
- System auto-count of "count transactions" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-document of "documents, fee schedule" (replaces manual Step 1).
...
- System auto-inspect of "inspection certificate" (replaces manual Step 3).
...
- System auto-collect of "collection boxes," (replaces manual Step 3).
...
### Automation Opportunity
- System auto-file of "File "Notice of Closure" with the RDO having jurisdiction over the store within…" (replaces manual Step 1).
- System auto-count of "counting System" (replaces manual Step 4).
...
### Automation Opportunity
- System auto-submit of "submits "Special Event Permit" request to the LGU Business Permits Office" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-file of "files ICC/SOC application via DTI's I-SEAL portal upon shipment departure from…" (replaces manual Step 1).
...
### Time Estimate
- Step 1: 4 hours/quarter
- Step 2: Ongoing
- Step 3: 2 hours/store
- Step 4: 4 hours
- Step 5: 1 hour
- Step 6: 1 day
- Step 7: 4 hours
...
### Automation Opportunity
- System auto-count of "countant prepares BIR branch registration requirements" (replaces manual Step 1).
- System auto-document of "documentary requirements" (replaces manual Step 2).
- System auto-generate of "Print" (replaces manual Step 3).
...
- System auto-record of "record retention" (replaces manual Step 3).
...
### Automation Opportunity
- System auto-validate of "check, online" (replaces manual Step 1).
...
- System auto-record of "recording" (replaces manual Step 3).
...
### Time Estimate
- Step 1: 8 hours/quarter
- Step 2: 8–20 hours per new processing activity
- Step 3: 4 hours/quarter
- Step 4: 2 hours/request
- Step 5: Variable (depends on severity)
- Step 6: 8 hours/year
- Step 7: 4 hours/year (DPO) + 30 min/employee
- Step 8: 2 hours/quarter
- *Draft roll-up from per-step Durations (mechanically derived by `07-methodology/backfill-time-estimate.py`). Annualize per the workflow's Frequency/Volume where the total drives headcount; refine to the per-step range + annual figure house style shown in WORKFLOW-FORMAT-GUIDE.md.*
