...
- System auto-create of "creates Transfer Order per W22 with "Inter-Island" transport mode flag" (replaces manual Step 3).
...
- System auto-dispatch of "dispatch doors" (replaces manual Step 2).
...
- System auto-scan of "scanner" (replaces manual Step 2).
...
- System auto-count of "count, duration, shift pattern — extended hours or additional shift" (replaces manual Step 2).
...
- System auto-update of "updates inventory status to "damaged/hold" in system to prevent allocation to…" (replaces manual Step 3).
