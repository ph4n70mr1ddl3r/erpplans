...
- auto-review (**engineering review**: structural, electrical, plumbing)
- auto-document (drawings**: prepare documentation for building permit)
- auto-generate (**bom/boq**: generate detailed bill of)
...
### Automation Opportunity
- auto-send (**rfp issuance**: send boq and specs)
- auto-submit (submission**: contractors submit technical and financial)
- auto-validate (internal estimate; check contractor capacity)
...
### Automation Opportunity
- auto-schedule (per project schedule (gantt))
- auto-inspect (weekly site inspections; progress monitoring vs.)
- auto-submit (billing**: contractor submits billing based on)
...
### Automation Opportunity
- auto-identify (**scope definition**: identify required repairs or)
- auto-review (store manager reviews proposed scope against)
- auto-submit (**budget approval**: submit for capex approval)
...
### Automation Opportunity
- auto-identify (**punch listing**: identify minor defects (snags))
- auto-test (**equipment testing**: test hvac, fire)
...
### Automation Opportunity
- auto-review (officer for review: includes hazard identification,)
- auto-submit (section 4: submits cshp, project duration,)
- workflow notification (with emergency contacts, toilet and washing)
...
### Automation Opportunity
- auto-document (laboratory requirements, documentation standards)
- auto-review (mill test reviewed; (d) cement certificates)
- auto-validate (pouring: (a) verify soil bearing capacity)
...
### Automation Opportunity
- auto-document (**baseline document set**: at ntp,)
- auto-submit (store ops) submits change request with)
- auto-log ((a) rfi logged in system with)
...
### Automation Opportunity
- auto-create (cadence, (d) create readiness tracker with)
- auto-generate (pc and printer, (g) systems integration)
- auto-validate (lookup, price check, customer lookup), (d))
...
| **Participants** | VP Store Operations, Real Estate Manager, Construction Manager, Store Manager (designee), IT Project Manager, HR Recruitment Manager, Merchandising VP, Supply Planning Manager, Legal Head, Regulatory Compliance Officer |
...
### Automation Opportunity
- rule-based auto-approval ((e) board approves annual expansion plan)
- auto-inspect (go-live: final inspection → opening day)
- auto-escalate (go-live → escalate with mitigation plan)
...
- Total annual: ~250–450 hours/year
