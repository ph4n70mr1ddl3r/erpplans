...
- **Cash sweep execution risk**: twice-weekly sweeps from 200 store deposit accounts to entity main operating accounts require precise timing; if a store deposit has not cleared before the sweep, the entity main account receives less cash than projected, potentially causing payment run shortfalls; mitigated by CTL-19 (bank reconciliation completeness.); CTL-47 (ensure ecommerce payment reconciliation accuracy)
