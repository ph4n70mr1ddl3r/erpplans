...
### Controls
- CTL-293 (ensure controlled execution — Cash Positioning and Forecasting (PA-18.1).)
...
### Automation Opportunity
- System auto-document of "document covering" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-count of "counting based on" (replaces manual Step 1).
- System auto-review of "reviews SCF agreement" (replaces manual Step 2).
- System auto-match of "match" (replaces manual Step 4).
...
- System auto-record of "record date" (replaces manual Step 2).
...
### Automation Opportunity
- System auto-capture of "enters PDC into ERP PDC module — records check number, bank, amount, maturity…" (replaces manual Step 1).
- System auto-validate of "check to Store/HQ Vault Custodian" (replaces manual Step 2).
- System auto-count of "count is not yet debited" (replaces manual Step 3).
...
### Pain Points / Risks
- **BP 22 evidence risk**: the Notice of Dishonor is the statutory anchor for a bouncing-checks case — late or unproven notice forfeits the criminal remedy; mitigated by immediate phone contact plus registered-mail notice with return card and system dating of the bank debit advice (steps 1, 4)
- **Double-recovery risk**: the customer redeems by bank transfer while the original check is re-presented, duplicating collection; mitigated by Treasury confirmation of redemption before the credit hold lifts and single-path settlement (steps 5–6)

### Automation Opportunity
- System auto-validate of "check" (replaces manual Step 1).
- System auto-count of "counts Receivable / Cr." (replaces manual Step 2).
- System auto-generate of "generates a debit memo for the "Returned Check Fee"" (replaces manual Step 3).
...
- System auto-count of "count opportunities" (replaces manual Step 3).
...
- System auto-import of "import payments" (replaces manual Step 2).
...
- Step 2: 10–15 min
- Step 3: 5–10 min
- Step 4: Bank-side (next day)
- Step 5: 1 hour/day (centralized for all 200 stores)
- Step 6: Automated
