...
- Integration with W117 (Lease Administration), W89 (Bank Reconciliation), and W556 / PA-15.2 (stale-dated check escheatment after 6 months for issued-but-uncashed PDCs)
...
- System auto-update of "register status updated to "Bounced — DAIF/DAUD"" (replaces manual Step 2).
- System auto-generate of "debit memo for the "Returned Check Fee"" (replaces manual Step 3).
