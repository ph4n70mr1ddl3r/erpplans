...
| **Volume** | 5 legal entities consolidated; ~PHP 5.19B/month gross cash inflows across 200 stores (cash ~42%, card ~36%, e-wallet ~15%, corporate/charge ~5%, online ~3% per profile §5); ~PHP 4.8B/month outflows (vendor payments ~PHP 2.5B, payroll ~PHP 230M, import LC/TT ~PHP 600M, Capex ~PHP 200M, taxes ~PHP 300M); ~210 bank accounts across 4 banking partners (BDO, BPI, Metrobank, Chinabank) |
| **Owner** | Treasury Analyst |
