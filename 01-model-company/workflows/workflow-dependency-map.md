...
> relationships for system functions. Of 5,349 total workflows, all 5,349 are classified into
> criticality tiers (the confirmed register holds 5,372 rows, incl. 23 `###` parent/summary
> sub-workflows); zero remain unclassified since the 2026-06-28 Full-Coverage Confirmation
> Pass (see [`workflow-criticality-classification.md`](workflow-criticality-classification.md)).
