...
| VS-129 Competition & Antitrust Compliance (RA 10677 / PCC) | Conduct controls layered on pricing (VS-57), vendor/trade terms (VS-03/VS-11/VS-43/VS-82), association conduct (VS-104), and marketplace/retail-media (VS-95/VS-48); owns the merger-notification gate on VS-130. Depends on VS-100 (legal), VS-88 (records), VS-21 (audit). |
