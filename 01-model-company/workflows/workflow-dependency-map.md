...
> relationships for system functions. Of 4,981 total workflows, 1,337 are classified into
> criticality tiers (the confirmed register holds 1,360 rows, incl. 23 `###` parent/summary
> sub-workflows); 3,644 remain unclassified; each carries a keyword-driven proposed tier in
...
> is no longer limited to the original 1,360 classified workflows. Mined by
