...
> relationships for system functions. Of 3,036 total workflows, 1,167 are classified into
> criticality tiers; 1,869 remain unclassified and default to Tier 2 pending review.
...
*Date: 2026-06-14 | Workflow Dependency Map v2.5 — covers prerequisite relationships for 1,167 classified workflows across 92 value streams with hard/soft/integration dependencies. Total repository workflows: 3,036. (The 96 workflows in VS-89–VS-92 and the 96 workflows in VS-93–VS-96, added 2026-06-14 via two gap-analysis passes, are unclassified and reference classified upstream dependencies via cross-links in their PA files; they will be incorporated into the dependency graph during the next classification pass.)*
