...
> relationships for system functions. Of 4,981 total workflows, 1,529 are classified into
> criticality tiers (the confirmed register holds 1,552 rows, incl. 23 `###` parent/summary
> sub-workflows); 3,452 remain unclassified; each carries a keyword-driven proposed tier in
