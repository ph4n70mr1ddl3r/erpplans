...
- System auto-calculate of "calculates ROP breaches based on" (replaces manual Step 1).
...
- System auto-route of "routes non-stock item creation request to Merchandise Planner for item master…" (replaces manual Step 3).
...
- System auto-count of "counts with recurring purchase history for the SKU" (replaces manual Step 2).
...
### Automation Opportunity
- System auto-update of "updates PO" (replaces manual Step 1).
...
### Automation Opportunity
- System auto-document of "documents — if LC payment terms" (replaces manual Step 1).
