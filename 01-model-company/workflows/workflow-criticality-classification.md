...
The **2,596** workflows not yet in the confirmed register above have been assigned a *proposed*
...
|---|---|---|
| Phase 1 | Go-Live Critical (Tier 1) — proposed | 512 |
| Phase 2 | Operational Excellence (Tier 2) — proposed | 1,935 |
| Phase 3 | Innovation & Optimization (Tier 3) — proposed | 149 |
| **Proposed Total** | | **2,596** |

| Coverage | Workflows |
|---|---|
| Confirmed (hand-reviewed) | 2,776 rows (2,753 unique `##` workflows) |
| Proposed (keyword, pending review) | 2,596 |
| Without even a proposal | 0 |
| **Grand Total** | **5,349** unique `##` workflows (2,753 confirmed + 2,596 unclassified, all proposed) |
