...
> Classifies operational workflows into criticality tiers (the confirmed register holds 5,372
...
> An additional 8 workflows (5,357 total − 5,349 classified) — W5497–W5504, added 2026-08-24/25 as
...
## Tier 1: Core Operations (1,375 Workflows)

These 1,375 workflows are foundational to daily store and supply chain operations.
...
## Tier 2: Standard Support (3,243 Workflows)

These 3,243 workflows are needed for standard operational support, cost controls, and category management.
...
## Tier 3: Advanced Optimization (754 Workflows)

These 754 workflows deliver advanced capabilities for competitive differentiation, AI-driven automation, and deep business analytics.
...
promoted by the Full-Coverage Confirmation Pass). On 2026-08-24/25, eight post-catalog workflow-level
gap fills (W5497–W5504) shipped unclassified and repopulated the proposal register;
...
|---|---|---|
| Phase 1 | Go-Live Critical (Tier 1) — proposed | 1 |
| Phase 2 | Operational Excellence (Tier 2) — proposed | 7 |
...
| Proposed (keyword, pending review) | 8 |
| Without even a proposal | 0 |
| **Grand Total** | **5,357** unique `##` workflows (5,349 confirmed + 8 unclassified) |

### Domain Breakdown

The per-tier subsection headings above (Core Finance, Extended Store Operations, Internal Audit, etc.) provide the authoritative domain-and-phase breakdown of the 5,372 classified register rows (5,349 unique workflows), and the [value-stream-index.md](./value-stream-index.md) provides the authoritative value-stream/process-area breakdown of all 5,357 workflows. A rolled-up "by domain" summary table was removed during consistency review because it could not be reconciled with the tier totals and presented stale partial counts.
...
| W4710 | Dependant & Family Visa, Schooling & Relocation Support | VS-160 |
