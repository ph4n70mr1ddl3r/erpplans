...
> Classifies all 5,422 unique operational workflows into criticality tiers (the confirmed
> register holds 5,445 rows, of which 23 are `###` parent/summary sub-workflows double-counted
...
> 2026-09-05 batch-22 gap-fill pass.
...
## Tier 2: Standard Support (3,293 Workflows)

These 3,293 workflows are needed for standard operational support, cost controls, and category management.
...
| Phase 2 | Operational Excellence (Tier 2) | 3,293 | 60.4% |
| Phase 3 | Innovation & Optimization (Tier 3) | 758 | 13.9% |
| **Confirmed Total** | | **5,445** | 100% |

> Counts include 23 `###` parent/summary sub-workflows (e.g. W5A/W9A/W54A) that receive their
> own classification row; the remaining 5,422 are canonical `##` workflows.
...
| Coverage | Workflows |
|---|---|
| Confirmed (hand-reviewed) | 5,445 rows (5,422 unique `##` workflows) |
| Proposed (keyword, pending review) | 0 |
| Without even a proposal | 0 |
| **Grand Total** | **5,422** unique `##` workflows (5,422 confirmed + 0 unclassified) |

### Domain Breakdown

The per-tier subsection headings above (Core Finance, Extended Store Operations, Internal Audit, etc.) provide the authoritative domain-and-phase breakdown of the 5,445 classified register rows (5,422 unique workflows), and the [value-stream-index.md](./value-stream-index.md) provides the authoritative value-stream/process-area breakdown of all 5,422 workflows. A rolled-up "by domain" summary table was removed during consistency review because it could not be reconciled with the tier totals and presented stale partial counts.
...
### Tier 2 Additions (538 Workflows)
