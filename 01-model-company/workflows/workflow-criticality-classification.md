...
> confirmed Tier 1 (1) / Tier 2 (3) in the 2026-09-05 batch-21 gap-fill pass.
...
## Tier 1: Core Operations (1,394 Workflows)

These 1,394 workflows are foundational to daily store and supply chain operations.
...
## Tier 2: Standard Support (3,289 Workflows)

These 3,289 workflows are needed for standard operational support, cost controls, and category management.
...
|---|---|---|---|
| Phase 1 | Go-Live Critical (Tier 1) | 1,394 | 25.6% |
| Phase 2 | Operational Excellence (Tier 2) | 3,289 | 60.4% |
| Phase 3 | Innovation & Optimization (Tier 3) | 758 | 13.9% |
| **Confirmed Total** | | **5,441** | 100% |

> Counts include 23 `###` parent/summary sub-workflows (e.g. W5A/W9A/W54A) that receive their
> own classification row; the remaining 5,418 are canonical `##` workflows.
...
| Coverage | Workflows |
|---|---|
| Confirmed (hand-reviewed) | 5,441 rows (5,418 unique `##` workflows) |
| Proposed (keyword, pending review) | 0 |
| Without even a proposal | 0 |
| **Grand Total** | **5,418** unique `##` workflows (5,418 confirmed + 0 unclassified) |

### Domain Breakdown

The per-tier subsection headings above (Core Finance, Extended Store Operations, Internal Audit, etc.) provide the authoritative domain-and-phase breakdown of the 5,441 classified register rows (5,418 unique workflows), and the [value-stream-index.md](./value-stream-index.md) provides the authoritative value-stream/process-area breakdown of all 5,418 workflows. A rolled-up "by domain" summary table was removed during consistency review because it could not be reconciled with the tier totals and presented stale partial counts.
...
### Tier 1 Additions (420 Workflows)
...
### Tier 2 Additions (534 Workflows)
