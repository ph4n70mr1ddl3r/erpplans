...
> An additional 2,733 workflows (3,900 total − 1,167 classified) remain unclassified pending review.
>
...
The **2,755** workflows not yet in the confirmed register above have been assigned a *proposed*
...
|---|---|---|
| Phase 1 | Go-Live Critical (Tier 1) — proposed | 610 |
| Phase 2 | Operational Excellence (Tier 2) — proposed | 2,017 |
| Phase 3 | Innovation & Optimization (Tier 3) — proposed | 128 |
| **Proposed Total** | | **2,755** |

| Coverage | Workflows |
|---|---|
| Confirmed (hand-reviewed) | 1,168 |
| Proposed (keyword, pending review) | 2,755 |
| Without even a proposal | 0 |
| **Grand Total** | **3,900** (note: 23 `###` sub-workflows are double-counted across confirmed rows; unique `##` workflow headers = 3,900) |
