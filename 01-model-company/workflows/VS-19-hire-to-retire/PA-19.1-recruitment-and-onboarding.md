...
### Pain Points / Risks
- **Sync lag risk**: Enrollment data sync lag between HR system and HMO provider creates coverage gaps
- **Documentation fraud risk**: Dependent documentation fraud (fake birth certificates)
- **Rising cost risk**: Rising HMO premiums in Philippine market (10–15% annual increase)
- **Limit exhaustion risk**: Max benefit limit exhaustion for high-cost hospitalizations
- **Network limitation risk**: Employee dissatisfaction with provider network limitations in provincial areas
...
- **Privacy risk**: Sensitive inquiry handling (complaints, payroll errors) requiring privacy beyond open ticketing system
...
### Pain Points / Risks
- **Data fragmentation risk**: Employee data spread across multiple systems (HR, payroll, benefits, recruitment) complicating DSAR fulfillment
- **Vendor privacy risk**: Third-party data sharing with HMO and benefits providers requires Data Processing Agreements
- **Regulatory risk**: NPC enforcement increasing in Philippines
