...
### Automation Opportunity
- System auto-count of "count Manager submits" (replaces manual Step 1).
...
| **Participants** | HR Business Partner, Recruitment Specialist, Store Manager (A/C), HR Director (A for policy), Payroll Specialist (I), Training Coordinator (C) |
