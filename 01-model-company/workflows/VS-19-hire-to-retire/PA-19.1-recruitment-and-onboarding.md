...
### Controls
- CTL-296 (ensure controlled execution — Recruitment and Onboarding (PA-19.1).)
...
| **Volume** | ~6,762 employees; all employees reviewed annually |
...
- **Total distributed effort**: ~6,000 hours/year across ~230 managers for ~6,762 employees
...
### Staffing Implication
- **No incremental headcount.** Performance reviews are distributed across ~230 managers (Store Managers, Dept. Supervisors, Dept. Heads). Annual cycle adds ~45 min/employee/year for ~6,762 employees = ~6,000 hours total effort, distributed across the management team.
...
### Automation Opportunity
- System auto-capture of "entertainment, other" (replaces manual Step 1).
- System auto-validate of "validates claim" (replaces manual Step 2).
...
- System auto-document of "documented purpose" (replaces manual Step 2).
...
| **Volume** | ~6,762 employees; ~20,700 sets of uniforms (3 per employee) + safety gear |
| **Owner** | HR Operations Manager |
| **Participants** | HR Assistant, Store/DC Manager, Procurement, Vendor, Employee |

### Background

With over 6,762 employees in retail and distribution, maintaining a consistent professional image and ensuring safety compliance (PPE) is a significant logistical task. BuildRight provides uniforms and mandatory safety gear (safety shoes, helmets, vests) to all store and DC personnel.
...
- System auto-count of "countability" (replaces manual Step 2).
...
- System auto-identify of "Identify "Ready Now" and "Ready in 1–2 Years" successors for all Store Manager…" (replaces manual Step 2).
...
### Automation Opportunity
- System auto-capture of "enters targeting fresh graduates" (replaces manual Step 1).
...
| **Volume** | 6,762 employee base; average ~120–180 sickness claims/month, ~40–60 maternity leaves/month, and ~250–350 loan applications/month |
...
### Automation Opportunity
- System auto-count of "count Manager submits the "Promodizer Incentive Program" mechanics" (replaces manual Step 1).
- System auto-track of "Tracking Module"" (replaces manual Step 2).
- System auto-generate of "generates a "Promodizer Sales Achievement Report" showing actual POS sales for…" (replaces manual Step 3).
...
- System auto-request of "Request" to Store Managers or Vendors found in violation of DOLE-174 guidelines" (replaces manual Step 6).
...
| **Volume** | 6,762 employees across all locations |
| **Owner** | CHRO |
...
- **Geographic coverage**: Providing equitable wellness services to 6,762 employees across 200 stores in provincial and island locations is logistically challenging; health screening and face-to-face counseling require physical presence
...
- **External EAP Provider**: Outsourced. Budgeted as employee benefit cost (~PHP 300–500/employee/year × 6,762 = ~PHP 2.0–3.4M/year).
...
- System auto-inspect of "inspection findings" (replaces manual Step 4).
...
### Automation Opportunity
- System auto-count of "count by role" (replaces manual Step 1).
- System auto-validate of "validates request against seasonal demand forecast" (replaces manual Step 2).
- System auto-document of "documentation requirements" (replaces manual Step 3).
...
| **Volume** | ~6,762 employees across 200 stores, 4 DCs, HQ |
...
- Step 1: 2 min
- Step 2: 5 min/award
- Step 3: 15 min/nomination
- Step 4: 4 hours/quarter
- Step 5: 2 hours/month
- Step 6: 4 hours/year
- Step 7: 2 hours
- Step 8: 4 hours
- *Draft roll-up from per-step Durations (mechanically derived by `07-methodology/backfill-time-estimate.py`). Annualize per the workflow's Frequency/Volume where the total drives headcount; refine to the per-step range + annual figure house style shown in WORKFLOW-FORMAT-GUIDE.md.*
...
| **Frequency** | ~100–130 enrollment/changes/month (new hires + events); annual renewal for 6,762 employees |
| **Volume** | ~6,762 covered employees + ~2,000 dependents across 5 entities |
| **Owner** | HR Benefits Specialist |
...
| **Volume** | ~6,762 active employee records + ~100,000 former applicant records + ~20,000 former employee records under retention |
...
| **Frequency** | Ongoing (~100–150 referrals/month across 6,762 employees) |
...
- System auto-submit of "Submitted → Validated → Interviewing → Offer → Hired / Not Hired" (replaces manual Step 3).
...
| **Volume** | ~10–15 internal communications/week across 6,762 employees in 205+ locations |
...
- **Pay equity analysis complexity**: comparing compensation across 6,762 employees in 5 entities with varying regional wage orders and role-specific allowances requires careful normalization to avoid misleading conclusions
...
- System auto-count of "countability to department heads for their area targets" (replaces manual Step 2).
...
| **Volume** | ~200 new hires chain-wide at any given time (based on annual turnover ~40% × 6,762 employees / 12 months) |
...
- System rule-based authorization of "authorized voids" (replaces manual Step 2).
...
- System auto-document of "documentation upload," (replaces manual Step 3).
...
| **Volume** | 6,762 employees × annual enrollment + ~200 qualifying life event changes/year |
...
Annual enrollment period: Preparation (2-3 days) + communication (4 hours) + enrollment processing (~40 hours for 6,762 employees) + verification (~20 hours) + transmission (4 hours) + audit (4 hours) = ~80–90 hours concentrated in 4-6 weeks. Ad-hoc qualifying events: ~20 min each × 200/year = ~67 hours distributed throughout year.
...
### Automation Opportunity
- System auto-count of "count within 24 hours — confirms all employees are safe, identifies employees…" (replaces manual Step 1).
- System auto-log of "logs claim" (replaces manual Step 2).
