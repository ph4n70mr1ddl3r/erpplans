...
- **Payroll anomaly detection gaps**: With ~6,757 employees, manual review of the payroll register for anomalies (unusually high OT, negative net pay, incorrect deductions) is time-consuming and error-prone; undetected errors cascade into incorrect payslips and bank transfers


### Automation Opportunity
- auto-schedule (overtime, and schedule adjustments are posted)
- auto-validate (payroll officer validates: basic salary +)
- auto-calculate (system calculates deductions: sss, philhealth,)
...
### Automation Opportunity
- auto-file (employee's compensation profile.)
- auto-log (system logic applies prioritization rules)
- auto-count (ap liability account.)
...
- **Automation Opportunity**: Auto-validation of off-cycle request completeness; auto-tax-computation engine for retroactive adjustments; auto-YTD integration with regular payroll; DOLE-deadline auto-tracking with escalation
- **Controls**: operational: Payroll Manager validation gate; Finance Manager approval for payments >PHP 50,000; minimum-wage-protection system guardrail; DOLE deadline compliance tracking
...
- **Automation Opportunity**: Auto-final-pay computation from separation type, salary history, leave balance, and outstanding loans; auto-clearance-status tracking across departments; auto-DOLE-deadline tracking with escalation
- **Controls**: operational: Payroll Manager computation review; DOLE 30-day final-pay compliance tracking; separation-pay formula validation per cause type; signed employee acknowledgment of final pay
...
- **Steps**:
  ...
  8. December 15–24: Finance Analyst executes payment via bank transfer; ensures all 6,757 employees receive payment by December 24 deadline per PD 851 (R: Finance Analyst, A: Finance Manager, Duration: 1 day)
...
- **Automation Opportunity**: Auto-13th-month-accrual from payroll register; consolidated multi-entity tracking; auto-tax-threshold monitoring with alerts; auto-DOLE-deadline tracking
- **Controls**: operational: Payroll Manager monthly accrual review; Finance Manager GL reconciliation; DOLE December 24 payment-deadline compliance tracking; PHP 90,000 tax-exemption threshold monitoring
...
### Automation Opportunity
- workflow orchestration (medical transport coordinated, (c) scene secured)
- auto-document (**incident documentation (within 4 hours)**:)
- auto-record (certificates, treatment records, and receipts collected)
...
### Automation Opportunity
- auto-generate (disbursement files generated and transmitted per)
- auto-allocate (services costs allocated to operating entities)
- auto-log (depot (60%), logistics (20%), digital commerce)
...
| **Volume** | 6,757 employees across 5 entities; ~PHP 100–120M/month in total statutory contributions (employee + employer share) |
| **Owner** | Payroll Manager |
...
### Automation Opportunity
- auto-review (payroll analyst reviews calculated contributions: (i))
- auto-count (designated bank account (not commingled —)
- auto-record (individual member records; (b) common discrepancies:)
...
| **Volume** | 6,757 employees across 5 legal entities; ~1,200–1,600 separations/year requiring pro-rated computation |
| **Owner** | Payroll Manager |
| **Participants** | Payroll Manager, HR Specialist, Controller, FP&A Analyst, DOLE Compliance Officer |

### Background

Philippine law (Presidential Decree No. 851) mandates that all employers pay a 13th month pay to rank-and-file employees, equivalent to 1/12 of the employee's total basic salary earned during the calendar year. This is a non-negotiable statutory obligation. For BuildRight Depot with 6,757 employees across 5 legal entities, the 13th month pay represents a significant financial obligation (~PHP 150–200M annually). Proper management requires: (a) monthly accrual booking to avoid year-end P&L shock, (b) accurate computation accounting for leaves without pay, salary changes, and mid-year hires, (c) pro-rated computation for separated employees (paid with final pay per W643), (d) tax treatment (13th month pay up to PHP 90,000 is tax-exempt per TRAIN law; excess is taxable), (e) DOLE compliance documentation. This workflow covers the monthly accrual, year-end computation, and compliance aspects of 13th month pay management.
...
### Automation Opportunity
- auto-review (fp&a analyst reviews monthly accrual vs.)
- auto-reconcile (payroll manager reconciles: (a) accumulated 13th)
- auto-generate (payroll manager generates mid-year 13th month)
...
| **Volume** | ~6,757 employees across 5 legal entities (200 stores + 4 DCs + HQ) |
| **Owner** | Payroll Manager |
...
### Automation Opportunity
- auto-calculate ((b) system auto-calculates per employee based)
- auto-review (payroll clerk reviews reports for anomalies:)
- auto-report (in contribution report; contributions for unregistered)
...
*Workflow Count: 10 · Back to **[VS-19: Hire-to-Retire](./README.md)** · [Value Stream Index](../value-stream-index.md)*