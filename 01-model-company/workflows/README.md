...
| Document | Purpose |
|---|---|
| [value-stream-index.md](value-stream-index.md) | **Master index** — all 112 value streams with workflow counts |
...
### Asset & Infrastructure (200 workflows)
| VS | Value Stream | Workflows |
|---|---|---|
...
### Governance & Assurance (600 workflows)
| VS | Value Stream | Workflows |
|---|---|---|
