...
| Document | Purpose |
|---|---|
| [value-stream-index.md](value-stream-index.md) | **Master index** — all 116 value streams with workflow counts |
