...
| Document | Purpose |
|---|---|
| [value-stream-index.md](value-stream-index.md) | **Master index** — all 128 value streams with workflow counts |
...
### Governance & Assurance (720 workflows)
| VS | Value Stream | Workflows |
|---|---|---|
