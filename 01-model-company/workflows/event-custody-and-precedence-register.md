...
| E-09 | In-store customer return | Customer Service Manager (per W1622 tiers) | VS-32 W1622–W1630 (eligibility, approval tiers, credit issuance, disposition) | VS-07 W12A/W12B/W12C (the store-execution variants: same-store counter flow, online-initiated drop-off ≈ 3,300–4,200/mo, cross-store with SM approval above PHP 5,000); VS-08 W1538 (multi-tender refund mechanics); VS-08 W605 (fraud screening) | The POS value stream executes tender mechanics only; return *decisions* never originate in VS-08; W1623 owns ALL ecommerce return requests (≈ 4,000–5,000/mo, ~10–12% of ~42,900 orders) of which W12B's store drop-offs are the ≈ 8–10% subset |
