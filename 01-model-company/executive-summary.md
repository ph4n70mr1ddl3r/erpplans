...
*Date: 2026-08-25 (updated counts: 728 requirements, 5,357 workflows across 188 value streams, 6,762 employees; two further post-catalog workflow-level gap fills added — W5503 restricted-substance & chemical-content product compliance (lead-in-paint per DENR CCO, formaldehyde, VOC), W5504 extreme-heat work interruption & occupational heat-stress management — joining the 2026-08-24 six: POSH/Safe Spaces CODI, RA 11165 telecommuting, director education, customer digital accessibility/WCAG, climate physical & transition risk, employee financial wellness).
