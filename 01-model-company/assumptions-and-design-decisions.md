...
| A2.6 | Revenue per employee | ~PHP 9.22M/year | Driven by optimized staffing and high automation; HQ rebalanced 315 → 357 (2026-06-20), then → 362 (2026-06-25) to stand up a dedicated S&OP/IBP sub-team in Supply Chain & Logistics (see `headcount-reality-check.md`) | Profile §4 |
