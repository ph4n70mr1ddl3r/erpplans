...
*Date: 2026-06-20 (v69 — consistency review #4: trimmed the v68 run-on footer (which nested v49–v68 with the "core foundational workflows" boilerplate repeated ~6×, duplicating CHANGELOG) and corrected its stale "unclassified 3,835→3,836" to the current **2,564 unclassified** (reduced by the 2026-06-20 hand-confirmation batches). Grand total remains **4,981 workflows / 173 value streams**. Per-version history is in [CHANGELOG.md](../CHANGELOG.md). Requirement-to-workflow mappings currently reference the core foundational workflows; mappings extending to the Expansion / Statutory / Gap-analysis value streams (VS-53–VS-177) are added incrementally. All 733 requirement mappings reconcile with erp-requirements.md.)*
