...
| 6 | Corporate, Governance & Asset Systems | CORP | Stream-aligned (configure) | VP Legal & Compliance; Facilities & Real Estate; Quality; Internal Audit & Risk | 35 | 919 |
| 7 | People Systems | PEO | Stream-aligned (configure) | CHRO | 16 | 442 |
...
| CORP | 12 (§4.6) + 22 (§4.7) + 1 (VS-115) | 919 |
| PEO | 16 (§4.5) | 442 |
...
| **Total** | **171 + 17 = 188** | **4,892 + 510 = 5,402** |
...
`capability-sourcing-and-engineering-model.md` v2.1.*
