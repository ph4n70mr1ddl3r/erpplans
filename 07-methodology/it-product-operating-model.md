...
| SSP | 20 (§4.3) + 1 (VS-59) + 3 (VS-23, VS-85, VS-147) + 1 (VS-151) | 877 |
...
| **Total** | **171 + 17 = 188** | **4,896 + 510 = 5,406** |
...
`capability-sourcing-and-engineering-model.md` v2.2.*
