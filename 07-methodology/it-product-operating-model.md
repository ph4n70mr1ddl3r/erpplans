...
| SSP | 20 (§4.3) + 1 (VS-59) + 3 (VS-23, VS-85, VS-147) + 1 (VS-151) | 881 |
| CCP | 24 (§4.3) + 1 (VS-146) | 740 |
| FIN | 29 (§4.4) + 1 (VS-86) | 809 |
| CORP | 12 (§4.6) + 22 (§4.7) + 1 (VS-115) | 923 |
| PEO | 16 (§4.5) | 444 |
...
| **Total** | **171 + 17 = 188** | **4,907 + 511 = 5,418** |
...
`capability-sourcing-and-engineering-model.md` v2.5.*
