...
| SSP | 20 (§4.3) + 1 (VS-59) + 3 (VS-23, VS-85, VS-147) + 1 (VS-151) | 878 |
| CCP | 24 (§4.3) + 1 (VS-146) | 740 |
| FIN | 29 (§4.4) + 1 (VS-86) | 808 |
| CORP | 12 (§4.6) + 22 (§4.7) + 1 (VS-115) | 920 |
| PEO | 16 (§4.5) | 444 |
...
| **Total** | **171 + 17 = 188** | **4,900 + 510 = 5,410** |
...
`capability-sourcing-and-engineering-model.md` v2.3.*
