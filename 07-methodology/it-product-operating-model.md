...
| 7 | People Systems | PEO | Stream-aligned (configure) | CHRO | 16 | 441 |
...
| SSP | 20 (§4.3) + 1 (VS-59) + 3 (VS-23, VS-85, VS-147) + 1 (VS-151) | 874 |
| CCP | 24 (§4.3) + 1 (VS-146) | 738 |
| FIN | 29 (§4.4) + 1 (VS-86) | 802 |
...
| **Total** | **171 + 17 = 188** | **4,878 + 510 = 5,388** |
...
`capability-sourcing-and-engineering-model.md` v1.9.*
