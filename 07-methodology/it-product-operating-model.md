...
(188 value streams, 569 process areas, 5,388 workflows).
...
| 3 | Store Systems & POS | SSP | Stream-aligned (buy & integrate) | VP Store Operations | 25 | 906 |
...
| SSP | 20 (§4.3) + 1 (VS-59) + 3 (VS-23, VS-85, VS-147) + 1 (VS-151) | 906 |
...
| **Total** | **171 + 17 = 188** | **4,934 + 492 = 5,426** |
...
| [`workflows/value-stream-index.md`](../01-model-company/workflows/value-stream-index.md) | The 188-VS / 569-PA / 5,388-WF catalog this model assigns to products |
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.9 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v2.0 (HQ 511 /
total 6,911), `model-company-profile.md` v2.27, `technical-guidelines.md` v3.2,
`capability-sourcing-and-engineering-model.md` v2.9.*
