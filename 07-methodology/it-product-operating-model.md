...
(188 value streams, 569 process areas, 5,384 workflows).
...
| 5 | Finance & Treasury Systems | FIN | Stream-aligned (configure) | CFO (Controller, Treasurer, Tax) | 30 | 801 |
...
| **Total** | **171 + 17 = 188** | **4,875 + 509 = 5,384** |
...
| [`workflows/value-stream-index.md`](../01-model-company/workflows/value-stream-index.md) | The 188-VS / 569-PA / 5,384-WF catalog this model assigns to products |
...
`capability-sourcing-and-engineering-model.md` v1.7.*
