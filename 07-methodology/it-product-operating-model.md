...
(188 value streams, 569 process areas, 5,387 workflows).
...
| **Total** | **171 + 17 = 188** | **4,878 + 509 = 5,387** |
...
| [`workflows/value-stream-index.md`](../01-model-company/workflows/value-stream-index.md) | The 188-VS / 569-PA / 5,387-WF catalog this model assigns to products |
...
`capability-sourcing-and-engineering-model.md` v1.8.*
