...
| [validate-repo.sh](validate-repo.sh) | Cross-reference validation script — 16 checks covering workflow counts, requirement/control IDs, classification register, dangling workflow references, markdown table structure, analysis-field-header canonicalization, PA-footer format, and boilerplate/tier-1 chain consistency |
