...
echo "  Overlap note: Check 10 now passes — the Expansion-block rework (completed 2026-06-20) eliminated all verbatim boilerplate, so the two remaining warnings no longer share one root cause. Check 1's unclassified total (2,564) spans the remainder of the Expansion block (VS-53–VS-78) and the gap-analysis block (VS-89–VS-177), partially tier-reviewed across seven classification batches. Check 12's field-adoption gap is concentrated in the blocks written before these fields became standard: Core (VS-01–VS-48), Statutory (VS-79–VS-88), the early gap-analysis passes (VS-89–VS-132), and VS-69–VS-71 — 105 of 173 value streams. The rest of the Expansion block and VS-133–VS-177 already carry both fields. See value-stream-index.md 'Value-Stream Blocks (origin)' for the maturity map."
