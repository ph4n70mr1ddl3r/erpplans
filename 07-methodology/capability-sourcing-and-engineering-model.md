...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v2.7): how
...
|---|---|---|
| **Tier 1** (1,383 workflows) | **Human-approval-gated only** | Agent drafts, summarizes, flags, or prepares — a named human decides and signs (approval-matrix evidence retained) |
| **Tier 2** (3,266) | **Bounded autonomy** | Agent acts inside hard guardrails (limits, whitelists, value caps); sampled human audit; auto-escalation on anomaly |
...
1. **Candidate intake** — the per-workflow Automation Opportunity inventory (5,384 workflows)
