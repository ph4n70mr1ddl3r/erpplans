...
|---|---|---|
| **Tier 1** (1,387 workflows) | **Human-approval-gated only** | Agent drafts, summarizes, flags, or prepares — a named human decides and signs (approval-matrix evidence retained) |
| **Tier 2** (3,274) | **Bounded autonomy** | Agent acts inside hard guardrails (limits, whitelists, value caps); sampled human audit; auto-escalation on anomaly |
...
1. **Candidate intake** — the per-workflow Automation Opportunity inventory (5,396 workflows)
