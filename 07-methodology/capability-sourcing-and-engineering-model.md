...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v2.6): how
...
| **Tier 2** (3,265) | **Bounded autonomy** | Agent acts inside hard guardrails (limits, whitelists, value caps); sampled human audit; auto-escalation on anomaly |
...
1. **Candidate intake** — the per-workflow Automation Opportunity inventory (5,381 workflows)
