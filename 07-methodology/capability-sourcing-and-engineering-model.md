...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v2.8): how
...
|---|---|---|
| **Tier 1** (1,384 workflows) | **Human-approval-gated only** | Agent drafts, summarizes, flags, or prepares — a named human decides and signs (approval-matrix evidence retained) |
| **Tier 2** (3,268) | **Bounded autonomy** | Agent acts inside hard guardrails (limits, whitelists, value caps); sampled human audit; auto-escalation on anomaly |
...
1. **Candidate intake** — the per-workflow Automation Opportunity inventory (5,387 workflows)
...
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v2.8: 17 teams incl. AAP, three archetypes, SEP, SIB, 122 FTE) |
