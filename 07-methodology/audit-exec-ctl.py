...
surfaces:
  ...
  * executive-summary.md narrative beyond its guarded figure anchors — every
    ...
    counts (728 requirements / 5,381 workflows / 188 VS / 6,762 HC [re-based
    5,377 → 5,381 by the 2026-09-03 people-capability & reporting-policy
    gap-fill pass (batch 9, W5525–W5528); previously re-based 5,363 → 5,364
...
ANCHORS = ["| Employees | 6,762 |", "| Active SKUs | 35,000 |",
           ...
           "728 requirements, 5,381 workflows across 188 value streams, 6,762 employees"]
